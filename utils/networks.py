...
# the input x [o,g], o is the observation and g is the goal
...
class Attnet(nn.Module):
    def __init__(self, env_params, hid_dim=128, out_dim=3):
        super(Attnet, self).__init__()

        self.fc1 = nn.Linear(env_params['obs'] + env_params['goal'], hid_dim, bias=False)
